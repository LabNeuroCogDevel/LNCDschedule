...
class PasswordDialog:
    def __init__(self, app=None, user=None):
        ...
        input_user.textChanged.connect(lambda x: update_value(x, "user", user_pass))
        input_password.textChanged.connect(lambda x: update_value(x, "pass", user_pass))
